...
pub mod bn254_fp {
    ...
    #[wasm_bindgen]
    #[derive(Clone, Copy)]
    pub struct WasmBn254FpDomain {
        pub log_size_of_group: i32,
        pub group_gen: WasmBn254Fp,
    }
    type WasmDomain = WasmBn254FpDomain;

    #[wasm_bindgen]
    impl WasmBn254FpDomain {
        #[wasm_bindgen(constructor)]
        pub fn new(log_size_of_group: i32, group_gen: WasmBn254Fp) -> Self {
            WasmDomain {
                log_size_of_group,
                group_gen,
            }
    ...
    #[wasm_bindgen]
    #[derive(Clone)]
    pub struct WasmBn254FpPlonkVerificationEvals {
        #[wasm_bindgen(skip)]
        pub sigma_comm: WasmVector<WasmPolyComm>,
        #[wasm_bindgen(skip)]
        pub coefficients_comm: WasmVector<WasmPolyComm>,
    ...
    type WasmPlonkVerificationEvals = WasmBn254FpPlonkVerificationEvals;

    #[wasm_bindgen]
    impl WasmBn254FpPlonkVerificationEvals {
        #[allow(clippy::too_many_arguments)]
        #[wasm_bindgen(constructor)]
        pub fn new(
            sigma_comm: WasmVector<WasmPolyComm>,
    ...
    type WasmShifts = WasmBn254FpShifts;

    #[wasm_bindgen]
    impl WasmBn254FpShifts {
        #[wasm_bindgen(constructor)]
        pub fn new(
            s0: WasmBn254Fp,
            s1: WasmBn254Fp,
    ...
    #[wasm_bindgen]
    #[derive(Clone)]
    pub struct WasmBn254FpLookupSelectors {
        #[wasm_bindgen(skip)]
        pub xor: Option<WasmPolyComm>,
        #[wasm_bindgen(skip)]
        pub lookup: Option<WasmPolyComm>,
    ...
    type WasmLookupSelectors = WasmBn254FpLookupSelectors;

    impl From<WasmLookupSelectors> for LookupSelectors<PolyComm<GAffine>> {
        fn from(x: WasmLookupSelectors) -> Self {
            Self {
                xor: x.xor.map(Into::into),
                lookup: x.lookup.map(Into::into),
    ...
    impl From<&LookupSelectors<PolyComm<GAffine>>> for WasmLookupSelectors {
    ...
    #[wasm_bindgen]
    impl WasmBn254FpLookupSelectors {
        #[wasm_bindgen(constructor)]
        pub fn new(
            xor: Option<WasmPolyComm>,
            lookup: Option<WasmPolyComm>,
    ...
    #[wasm_bindgen]
    #[derive(Clone)]
    pub struct WasmBn254FpLookupVerifierIndex {
        pub joint_lookup_used: bool,
    ...
    type WasmLookupVerifierIndex = WasmBn254FpLookupVerifierIndex;

    impl From<&LookupVerifierIndex<GAffine>> for WasmLookupVerifierIndex {
    ...
    impl From<&WasmLookupVerifierIndex> for LookupVerifierIndex<GAffine> {
        fn from(x: &WasmLookupVerifierIndex) -> Self {
            Self {
                joint_lookup_used: x.joint_lookup_used.into(),
                lookup_table: x.lookup_table.clone().iter().map(Into::into).collect(),
    ...
    #[wasm_bindgen]
    impl WasmBn254FpLookupVerifierIndex {
        #[wasm_bindgen(constructor)]
        pub fn new(
            joint_lookup_used: bool,
            lookup_table: WasmVector<WasmPolyComm>,
    ...
    #[wasm_bindgen]
    #[derive(Clone)]
    pub struct WasmBn254FpPlonkVerifierIndex {
        pub domain: WasmDomain,
        pub max_poly_size: i32,
        pub public_: i32,
        pub prev_challenges: i32,
        #[wasm_bindgen(skip)]
        pub srs: WasmBn254FpSrs,
        #[wasm_bindgen(skip)]
        pub evals: WasmPlonkVerificationEvals,
        pub shifts: WasmShifts,
        #[wasm_bindgen(skip)]
    ...
    type WasmPlonkVerifierIndex = WasmBn254FpPlonkVerifierIndex;

    #[wasm_bindgen]
    impl WasmBn254FpPlonkVerifierIndex {
        #[wasm_bindgen(constructor)]
        pub fn new(
            domain: &WasmDomain,
            max_poly_size: i32,
        ...
        #[wasm_bindgen(getter)]
        pub fn srs(&self) -> WasmBn254FpSrs {
            self.srs.clone()
        }

        #[wasm_bindgen(setter)]
        pub fn set_srs(&mut self, x: WasmBn254FpSrs) {
            self.srs = x
        }
    ...
    pub fn to_wasm<'a>(
        srs: &Arc<PairingSRS<Bn<ark_bn254::Parameters>>>,
        vi: DlogVerifierIndex<GAffine, PairingProof<Bn<ark_bn254::Parameters>>>,
    ) -> WasmPlonkVerifierIndex {
        WasmPlonkVerifierIndex {
            domain: WasmDomain {
                log_size_of_group: vi.domain.log_size_of_group as i32,
            ...
            srs: srs.into(),
            evals: WasmPlonkVerificationEvals {
                sigma_comm: IntoIterator::into_iter(vi.sigma_comm)
                    .map(From::from)
                    .collect(),
                coefficients_comm: IntoIterator::into_iter(vi.coefficients_comm)
                    .map(From::from)
                    .collect(),
                generic_comm: vi.generic_comm.into(),
                psm_comm: vi.psm_comm.into(),
    ...
    pub fn of_wasm(
        ...
        DlogVerifierIndex<GAffine, PairingProof<Bn<ark_bn254::Parameters>>>,
        Arc<PairingSRS<Bn<ark_bn254::Parameters>>>,
    ) {
        let max_poly_size = index.max_poly_size;
        let public_ = index.public_;
        let prev_challenges = index.prev_challenges;
        ...
        let index = DlogVerifierIndex {
            ...
            endo: poly_commitment::srs::endos::<GAffineOther>().1,
            max_poly_size: max_poly_size as usize,
            public: public_ as usize,
            prev_challenges: prev_challenges as usize,
            permutation_vanishing_polynomial_m: {
    ...
    impl From<WasmPlonkVerifierIndex>
        for DlogVerifierIndex<GAffine, PairingProof<Bn<ark_bn254::Parameters>>>
    {
        fn from(index: WasmPlonkVerifierIndex) -> Self {
            of_wasm(index).0
        }
    ...
    pub fn read_raw(
        ...
        srs: &WasmBn254FpSrs,
        path: String,
    ) -> Result<DlogVerifierIndex<GAffine, PairingProof<Bn<ark_bn254::Parameters>>>, JsValue> {
        let path = Path::new(&path);
        DlogVerifierIndex::<GAffine, PairingProof<Bn<ark_bn254::Parameters>>>::from_file(
            srs.0.clone(),
            path,
            offset.map(|x| x as u64),
    ...
    #[wasm_bindgen]
    pub fn caml_bn254_fp_plonk_verifier_index_read(
        offset: Option<i32>,
        srs: &WasmBn254FpSrs,
        path: String,
    ) -> Result<WasmPlonkVerifierIndex, JsValue> {
    ...
    #[wasm_bindgen]
    pub fn caml_bn254_fp_plonk_verifier_index_write(
        append: Option<bool>,
        index: WasmPlonkVerifierIndex,
        path: String,
    ) -> Result<(), JsValue> {
        let index: DlogVerifierIndex<GAffine, PairingProof<Bn<ark_bn254::Parameters>>> =
            index.into();
        let path = Path::new(&path);
        index.to_file(path, append).map_err(|e| {
            println!("{}", e);
    ...
    #[wasm_bindgen]
    pub fn caml_bn254_fp_plonk_verifier_index_serialize(index: WasmPlonkVerifierIndex) -> String {
        let index: DlogVerifierIndex<GAffine, PairingProof<Bn<ark_bn254::Parameters>>> =
            index.into();
        serde_json::to_string(&index).unwrap()
    }
    ...
    #[wasm_bindgen]
    pub fn caml_bn254_fp_plonk_verifier_index_deserialize(
        srs: &WasmBn254FpSrs,
        index: String,
    ) -> Result<WasmPlonkVerifierIndex, JsError> {
        let vi: Result<
    ...
    #[wasm_bindgen]
    pub fn caml_bn254_fp_plonk_verifier_index_create(
    ...
    #[wasm_bindgen]
    pub fn caml_bn254_fp_plonk_verifier_index_shifts(log2_size: i32) -> WasmShifts {
    ...
    #[wasm_bindgen]
    pub fn caml_bn254_fp_plonk_verifier_index_dummy() -> WasmPlonkVerifierIndex {
        fn comm() -> WasmPolyComm {
            let g: WasmGBn254 = GAffine::prime_subgroup_generator().into();
            WasmPolyComm {
                shifted: None,
                unshifted: vec![g].into(),
            }
        ...
        WasmPlonkVerifierIndex {
            ...
            public_: 0,
            prev_challenges: 0,
            srs: WasmBn254FpSrs(Arc::new(PairingSRS::create(x, 0))),
            evals: WasmPlonkVerificationEvals {
                sigma_comm: vec_comm(PERMUTS),
                coefficients_comm: vec_comm(COLUMNS),
                generic_comm: comm(),
    ...
    #[wasm_bindgen]
    pub fn caml_bn254_fp_plonk_verifier_index_deep_copy(
        x: &WasmPlonkVerifierIndex,
    ) -> WasmPlonkVerifierIndex {
        x.clone()
    }
